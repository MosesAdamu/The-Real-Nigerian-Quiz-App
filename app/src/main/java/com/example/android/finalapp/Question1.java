...
public class Question1 extends Activity {
    ...
    private void recordAnswer(char answer, View v) {
        ...
        if(question.isCorrect(answer)) {
            ...
            //msg = Toast.makeText(getBaseContext(), "Correct Answer is "  ,Toast.LENGTH_LONG);
        }
        msg.show();
        gotoNextQuestion(v);
    }
 ...
 /**   // eventually make this record answer
    private void recordAnswer(char answer, View v) {
        ...
        if(question.isCorrect(answer)) {
            ...
            quizDriver.recordAnswer(questionNumber, false);
            msg = Toast.makeText(getBaseContext(), "Incorrect Answer! :(", Toast.LENGTH_LONG);
            msg = Toast.makeText(getBaseContext(), "Correct Answer is " + questionNumber,Toast.LENGTH_LONG);
        }
        msg.show();
        gotoNextQuestion(v);
    }
